...
body = body.replace(/"annual_fee_begin_time\":"\d+"/g,'"annual_fee_begin_time":"2022-12-08 15:51:09"');
body = body.replace(/"annual_fee_end_time\":"\d+"/g,'"annual_fee_end_time":"9999-12-08 15:51:09"');
body = body.replace(/"su_vip_end_time\":"\d+"/g,'"su_vip_end_time":"2022-12-03 15:51:09"');
body = body.replace(/"vip_end_time\":"\d+-\d+-\d+ \d+:\d+:\d+"/g,'"vip_end_time":"9999-12-08 15:51:09"');
body = body.replace(/"roam_type\":\d/g,'"roam_type":1');
body = body.replace(/"roam_end_time\":"\d+"/g,'"roam_end_time":"2099-02-21 21:54:36"');
body = body.replace(/"m_y_endtime\":"\d+"/g,'"m_y_endtime":"2030-02-21 21:54:36"');
body = body.replace(/"vip_y_endtime\":"\d+"/g,'"vip_y_endtime":"2030-02-21 21:54:36"');
body = body.replace(/"m_type\":\d/g,'"m_type":1');
body = body.replace(/"m_is_old\":\d/g,'"m_is_old":1');
body = body.replace(/"su_vip_y_endtime\":"\d+"/g,'"su_vip_y_endtime":"2030-02-21 21:54:36"');
body = body.replace(/"roam_begin_time\":"\d+"/g,'"roam_begin_time":"2022-02-21 21:54:36"');
body = body.replace(/"y_type\":\d/g,'"y_type":1');
body = body.replace(/"signed_svip_before\":\d/g,'"signed_svip_before":1');
body = body.replace(/"end_time\":"\d+"/g,'"end_time":"2099-02-21 21:54:36"');
